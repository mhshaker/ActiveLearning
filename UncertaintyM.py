...
def uncertainty_set14(probs, credal_size=30):
	p = [] #np.array(probs)
	for data_point in probs:
		d_p = []
		for sampling_seed in range(credal_size):
...
def uncertainty_set15(probs, credal_size=30):
	p = [] #np.array(probs)
	for data_point in probs:
		d_p = []
		for sampling_seed in range(credal_size):
...
def uncertainty_set14_convex(probs,credal_size=30):
	p = [] #np.array(probs)
	for data_point in probs:
		d_p = []
		for sampling_seed in range(credal_size):
...
def uncertainty_set15_convex(probs, credal_size=30):
	p = [] #np.array(probs)
	for data_point in probs:
		d_p = []
		for sampling_seed in range(credal_size):
